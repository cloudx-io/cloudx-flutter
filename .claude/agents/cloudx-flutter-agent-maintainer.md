...
cd /path/to/cloudx-flutter-private
...
# - lib/listeners/*.dart (all listener interfaces)
```
...
**Detection:**
- Found new file: `lib/widgets/cloudx_native_view.dart` in SDK
- Not present in SDK_VERSION.yaml `api_signatures.flutter`
- **Decision:** New API added

**Actions:**
1. Read CloudXNativeView API to understand usage
...
- Widgets: `lib/widgets/cloudx_banner_view.dart`, `cloudx_mrec_view.dart`
- Listeners: `lib/listeners/cloudx_ad_view_listener.dart`, etc.
...
- Flutter SDK version (pubspec.yaml): 0.9.0
- Tracked version (SDK_VERSION.yaml): 0.1.2
- ⚠️ Version bump detected: 0.1.2 → 0.9.0
...
- ✅ All "0.9.0" references in place (X total)
...
**Summary:**
- Detected: Version bump (0.1.2 → 0.9.0)
...
Adding new widget... (CloudXNativeView)
...
**Next steps:**
1. Review changes
2. Commit: \"Sync Flutter agents for SDK v0.9.0 (API updates)\"
3. Push to repo"
